...
int main() 
{
	...
	cl::Buffer vincbuff00(ctx, CL_MEM_READ_WRITE, ::size_t (2*n*n));
	cl::Buffer wincbuff00(ctx, CL_MEM_READ_WRITE, ::size_t (2*n*n));	
	cl::Buffer vincbuff01(ctx, CL_MEM_READ_WRITE, ::size_t (2*n*n));
	cl::Buffer wincbuff01(ctx, CL_MEM_READ_WRITE, ::size_t (2*n*n));	
	cl::Buffer vincbuff02(ctx, CL_MEM_READ_WRITE, ::size_t (2*n*n));
	cl::Buffer wincbuff02(ctx, CL_MEM_READ_WRITE, ::size_t (2*n*n));	
	cl::Buffer vincbuff03(ctx, CL_MEM_READ_WRITE, ::size_t (2*n*n));
	cl::Buffer wincbuff03(ctx, CL_MEM_READ_WRITE, ::size_t (2*n*n));	
	cl::Buffer vincbuff04(ctx, CL_MEM_READ_WRITE, ::size_t (2*n*n));
	cl::Buffer wincbuff04(ctx, CL_MEM_READ_WRITE, ::size_t (2*n*n));	
	cl::Buffer vincbuff05(ctx, CL_MEM_READ_WRITE, ::size_t (2*n*n));
	cl::Buffer wincbuff05(ctx, CL_MEM_READ_WRITE, ::size_t (2*n*n));	
	cl::Buffer vincbuff06(ctx, CL_MEM_READ_WRITE, ::size_t (2*n*n));
	cl::Buffer wincbuff06(ctx, CL_MEM_READ_WRITE, ::size_t (2*n*n));	
	cl::Buffer vincbuff07(ctx, CL_MEM_READ_WRITE, ::size_t (2*n*n));
	cl::Buffer wincbuff07(ctx, CL_MEM_READ_WRITE, ::size_t (2*n*n));	
	cl::Buffer vincbuff08(ctx, CL_MEM_READ_WRITE, ::size_t (2*n*n));
	cl::Buffer wincbuff08(ctx, CL_MEM_READ_WRITE, ::size_t (2*n*n));	
	cl::Buffer vincbuff09(ctx, CL_MEM_READ_WRITE, ::size_t (2*n*n));
	cl::Buffer wincbuff09(ctx, CL_MEM_READ_WRITE, ::size_t (2*n*n));	
	cl::Buffer vincbuff10(ctx, CL_MEM_READ_WRITE, ::size_t (2*n*n));
	cl::Buffer wincbuff10(ctx, CL_MEM_READ_WRITE, ::size_t (2*n*n));	
	cl::Buffer vincbuff11(ctx, CL_MEM_READ_WRITE, ::size_t (2*n*n));
	cl::Buffer wincbuff11(ctx, CL_MEM_READ_WRITE, ::size_t (2*n*n));	
	cl::Buffer vincbuff12(ctx, CL_MEM_READ_WRITE, ::size_t (2*n*n));
	cl::Buffer wincbuff12(ctx, CL_MEM_READ_WRITE, ::size_t (2*n*n));	
	cl::Buffer vincbuff13(ctx, CL_MEM_READ_WRITE, ::size_t (2*n*n));
	cl::Buffer wincbuff13(ctx, CL_MEM_READ_WRITE, ::size_t (2*n*n));	
	cl::Buffer vincbuff14(ctx, CL_MEM_READ_WRITE, ::size_t (2*n*n));
	cl::Buffer wincbuff14(ctx, CL_MEM_READ_WRITE, ::size_t (2*n*n));	
	cl::Buffer vincbuff15(ctx, CL_MEM_READ_WRITE, ::size_t (2*n*n));
	cl::Buffer wincbuff15(ctx, CL_MEM_READ_WRITE, ::size_t (2*n*n));	
	...
	cl::Buffer Vincbuff(ctx, CL_MEM_READ_WRITE, ::size_t (8*n*n));
	cl::Buffer Intbuff(ctx, CL_MEM_READ_WRITE, ::size_t (8*n));
	cl::Buffer Intincbuff(ctx, CL_MEM_READ_WRITE, ::size_t (8*n*n));

...
int main() 
{
	...
	for (int i = 0; i<nDevs ; i++)
	{
		...
		ker_S_interm[i].setArg(4, nbuff);
		ker_S_interm[i].setArg(5, Vsumbuff);
		ker_S_interm[i].setArg(7, Intsumbuff);


		ker_Sp[i].setArg(0, vincbuff[0]);
		ker_Sp[i].setArg(1, wincbuff[0]);	
		ker_Sp[i].setArg(2, nbuff);	
		ker_Sp[i].setArg(3, Vincbuff[0]);
		ker_Sp[i].setArg(4, Intincbuff[0]);

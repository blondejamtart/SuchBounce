...
clearvars -except l q rad scale_xy scale_xz offset xmax xmin ymax ymin zmax zmin
recalc = 1;
[tempset,~] = fileread('Particle_tracks.dat',l,1,512);
...
for t = 1:size(r_scaled_xy,1)
    ...
    if charged
        ...
        temp_frame_xy(:,:,1) = Framesplit_1(:,:,1);
        temp_frame_xz(:,:,1) = Framesplit_2(:,:,1);
    end

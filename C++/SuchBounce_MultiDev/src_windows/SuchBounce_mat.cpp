...
//	}
	...
	// Build Kernels	
	cl::Kernel ker_F;
	if (stuff[0] < 0) { ker_F = kernel_init("src_windows\\F_Hybrid_mat_reversed.cl", "Fimp", ctx, ctxDevices, OpenCL_log); }	
	else { ker_F = kernel_init("src_windows\\F_Hybrid_mat.cl", "Fimp", ctx, ctxDevices, OpenCL_log); }
	...
	cl::Kernel ker_Sp = kernel_init("src_windows\\reduce_pairwise.cl", "red_pair", ctx, ctxDevices, OpenCL_log);
	cl::Kernel ker_S_interm = kernel_init("src_windows\\reduce_mat_interm.cl", "red_copy", ctx, ctxDevices, OpenCL_log);	
	...
	cl::Kernel ker_scale = kernel_init("src_windows\\time_scaler.cl", "Scale", ctx, ctxDevices, OpenCL_log);		

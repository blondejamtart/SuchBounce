...
int main() 
{
	...
	int b = l4[0];
	//std::cout << a << "," << b << "\n";
	ker_F.setArg(11, vincbuff[a*(n/128)+b]);
	ker_F.setArg(12, wincbuff[a*(n/128)+b]);
	ker_F.setArg(15, Vincbuff[a*(n/128)+b]);
	ker_F.setArg(16, Intincbuff[a*(n/128)+b]);
	ker_F.setArg(13, vincbuff[b*(n/128)+a]);
	ker_F.setArg(14, wincbuff[b*(n/128)+a]);
	ker_F.setArg(17, Vincbuff[b*(n/128)+a]);
	ker_F.setArg(18, Intincbuff[b*(n/128)+a]);			

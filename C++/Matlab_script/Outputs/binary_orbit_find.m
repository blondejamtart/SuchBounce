function [r_offset, v_offset, settings, settings_length] = binary_orbit_find(R_encounter,V_inf)
...
vel = sqrt((2*6.67384e-11*5.972e24/(6.371e6+R_encounter))+KE_V_inf);

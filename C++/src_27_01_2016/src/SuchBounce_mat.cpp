...
int main() 
{
	...
	cl::Buffer l3buff(ctx, CL_MEM_READ_ONLY | CL_MEM_COPY_HOST_PTR, ::size_t(2*n*n), l3);
	...
	cl::Buffer vincbuff(ctx, CL_MEM_READ_WRITE, ::size_t (8*n*n*4));
	cl::Buffer wincbuff(ctx, CL_MEM_READ_WRITE, ::size_t (8*n*n*4));
